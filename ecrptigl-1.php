<?php
//    ecrptigl.php
//    $Revision: 1.1 $ - $Date: 2007-11-14 09:34:35-05 $
//
...
$q3='SELECT `aresmem`,`drillsnum`,`drillshrs`,`psesnum`,`pseshrs`,' .
  '`eopsnum`,`eopshrs`,`aresopsnum`,`aresops`,`period` ' .
...
while ( $row3 = getRow($r3,$db) )
  {
	...
	$y1[$i] = $row3[2]; // Drills
	$y2[$i] = $row3[4]; // Public Service
	$y3[$i] = $row3[6]; // Emergency
	$y4[$i] = $row3[8]; // Admin
      }
  }
