...
function showload (){
    document.getElementById("middiv").innerHTML = "<b>Working...</b>";
}
	
function doneload (){
    document.getElementById("middiv").innerHTML = "<b>_ complete _</b>";
}
...
//     setTimeout('doneload()',refreshrate);;
// }
...
//     setTimeout ('runajax ("middiv","midpic.php")',refreshrate);
//     //Re-load the navigation.
//     setTimeout ('runajax ("picdiv","picnav.php")',2*refreshrate);
// }
